...
class IntentClassifier:
    def __init__(self, model_dir_path, model_name="intentclassifier"):

        intents_data = os.path.join(model_dir_path, "intents.json")
        model_name = os.path.join(model_dir_path, model_name)
    ...
    def load_model(self):
        self.model = tf.keras.models.load_model(f"{self.model_name}.keras")
